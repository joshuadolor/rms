<template>
  <section class="w-full px-6 pb-20" aria-label="Map">
    <div class="max-w-6xl mx-auto h-[400px] bg-t1-bg-light rounded-lg overflow-hidden border border-t1-border relative">
